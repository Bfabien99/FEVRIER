...
<body>
    ...
    <div class="main">
        ...
        <section class="intro">
            ...
            <h3 style="color:green; text-align:justify; font-size:1em;">La Côte d'Ivoire est une destination touristique avec beaucoup de potentiel qui vaut le détour.<br>
